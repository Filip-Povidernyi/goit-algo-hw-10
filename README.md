...
### Висновок
Метод Монте-Карло дає точне наближення до істинного значення інтеграла навіть при помірній кількості ітерацій (N = 100000). Результати демонструють високу точність методу при достатній кількості випадкових точок.
